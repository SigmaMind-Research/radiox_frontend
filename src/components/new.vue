        ...
        <v-list>
            <v-list-item>
                ...
                <v-card id="card" title="Brightness" variant="toned">
                    ...
                    <v-slider v-model="briVal" :max="200" track-color="white" color="white" class="slid"></v-slider>
                </v-card>
                <v-card id="card" title="Contrast" variant="toned">
                    <label id="lab" for="briVal" location="">{{ (conVal - 100).toFixed(1) }}</label>
                    <v-slider v-model="conVal" :max="200" track-color="white" color="white" class="slid"></v-slider>
                </v-card>
            </v-list-item>
        </v-list>
    </v-navigation-drawer>
        ...
        <v-bottom-navigation v-model="value" color="blue" class="overflow-visible" style="height: 56px;" grow>
            <v-row justify="center">
                ...
                <v-menu transition="scroll-y-reverse-transition" width="300px" :close-on-content-click="false">
                    ...
                    <v-list>
                        <v-list-item>
                            <v-slider v-model="briVal" :max="200" track-color="white" color="white" class="slid"
                ...
                <v-menu transition="scroll-y-reverse-transition" width="300px" :close-on-content-click="false">
                    ...
                    <v-list>
                        <v-list-item>
                            <v-slider v-model="conVal" :max="200" track-color="white" color="white" class="slid"
                                style="padding-top: 7px"></v-slider>
